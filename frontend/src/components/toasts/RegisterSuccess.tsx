interface RegisterSuccessToastInterface {
    content: string,
    closeHandler?: React.MouseEventHandler<HTMLButtonElement>,
}

export default function RegisterSuccessToast({ content, closeHandler }: RegisterSuccessToastInterface) {

    const CheckCircle = () => {
        return (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
        )
    };
